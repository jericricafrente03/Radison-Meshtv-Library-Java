package com.ph.bittelasia.meshtv.tv.mtvlib.SignageV2.View.SpecialFragment.WeatherForecast.WeatherForecastFragment2;
...
public class SignageForecastAdapter2 extends MeshTVAdapter<MeshWeatherForecastDay>{

    public SignageForecastAdapter2(Context context, GridView gv_view, int layoutResourceId, ArrayList<MeshWeatherForecastDay> data) {
        super(context, gv_view, layoutResourceId, data);
    }

    @Override
    public MeshTVVHolder setViewHolder() {
        return new SignageForecastViewHolder2();
    }

    @Override
    public void updateRow(MeshTVVHolder vh, MeshWeatherForecastDay o) {
        SignageForecastViewHolder2 svh = (SignageForecastViewHolder2)vh;
    ...
    public int setLayout() {
        return R.layout.signage_weather_forecast_item_2;
    }
}
