...
/**
 * Requests for Shopping Data
 * {@link com.ph.bittelasia.meshtv.tv.mtvlib.Realm.Model.Shopping.MeshShoppingItem MeshShoppingItem}
 * <br>
 * Implements {@link MeshParamListener MeshParamListener} to set parameters for the API call
 * @author Mars Ray Canizares Araullo
 * @version 1.0
 */
public class MeshGetShopTask extends AsyncTask<Void,Void,String> implements MeshParamListener {

    //==============================================Variable========================================
    //----------------------------------------------Constant----------------------------------------
    public static final String TAG = MeshGetShopTask.class.getSimpleName();
    //----------------------------------------------------------------------------------------------
    //----------------------------------------------Instance----------------------------------------
    /**
     ...
     */
    public MeshGetShopTask(Context context, MeshRequestListener listener) {
        if (context == null) {
    ...
    protected String doInBackground(Void... voids) {
        ...
        return get.get(context, MeshGET.SHOPPING_ITEM, this);
    }
