 ...
 * @version 2.0
 */
class BittelSignageGetTask extends AsyncTask<Void,Void,String> implements MeshParamListener
{
    //=========================================Variable=============================================
    //-----------------------------------------Constant---------------------------------------------
    public static final String TAG = BittelSignageGetTask.class.getSimpleName();
    //----------------------------------------------------------------------------------------------
    //-----------------------------------------Instance---------------------------------------------
    /**
     ...
     */
    BittelSignageGetTask(Class c, MeshDataListener listener)
    {
        this.c = c;
     ...
     */
    BittelSignageGetTask(Class c, MeshDataListener listener, MeshAdditionalParam additionalParam)
    {
        this.c = c;
        this.listener = listener;
        this.context = MeshTVApp.get().getBaseContext();
     ...
     * @param listener Listens for the result of the request
     */
    BittelSignageGetTask(Context context, int dataSource, Class c, MeshDataListener listener)
    {
        this.c = c;
        this.listener = listener;
     ...
     */
    BittelSignageGetTask(Context context, int dataSource, MeshDataListener listener, String data)
    {
        this.listener = listener;
        this.context = context;
        this.dataSource = dataSource;
    ...
    private void setClass(String s)
    {
        ...
        switch (classname)
        {
            ...
            case MeshData.SCROLLING_MESSAGES:
                ...
                break;
            case MeshSignageGET.LAYOUT:
                c = MeshLayout.class;
                break;
            case MeshSignageGET.SCHEDULE:
                c = MeshSchedule.class;

                break;
            case MeshSignageGET.SIGNAGE_SCHEDULE:
                c = MeshSignageSchedule.class;

                break;
            case MeshSignageGET.SIGNAGE:
                c = MeshSignage.class;

                break;
            case MeshSignageGET.COMPANY:
                c = MeshCompany.class;

                break;
            case MeshSignageGET.TELE_BILL:
                c = MeshTelecomBill.class;
                break;
            case MeshSignageGET.EPG:
                c = MeshEPG.class;
                break;
            case MeshSignageGET.SUBSCRIBERS:
                c = MeshSubscriber.class;
                break;
            case MeshSignageGET.SUBSCRIPTIONS:
                c = MeshSubscription.class;
                break;
            case MeshSignageGET.PACKAGES:
                c = MeshPackage.class;
                break;
            case MeshSignageGET.PACKAGE_CHANNELS:
                c = MeshPackageChannel.class;
                break;
            case MeshSignageGET.VOD_BOUGHT:
                c = MeshVODBought.class;
                break;
            case MeshSignageGET.XBILL:
                c = MeshBillV2.class;
                break;
            case MeshSignageGET.AIRMEDIA_USER:
                c = MeshAirMedia.class;
                break;
            case MeshSignageGET.CONCIERGE_CATEGORY:
                c = MeshConciergeCategory.class;
                break;
            case MeshSignageGET.TV:
                c = MeshChannel.class;
                break;
            case MeshSignageGET.TV_CATEGORY:
                c = MeshChannelCategory.class;
                break;
            case MeshSignageGET.ITEM_REQ:
                c= MeshConciergeRequestItem.class;
                break;
            case MeshSignageGET.SVC_REQ:
                c = MeshConciergeRequestService.class;
                break;
            case MeshSignageGET.FOOD:
                c = MeshFood.class;
                break;
            case MeshSignageGET.FOOD_CATEGORY:
                c = MeshFoodCategory.class;
                break;
            case MeshSignageGET.FACILITY:
                c = MeshFacility.class;
                break;
            case MeshSignageGET.FACILITY_CATEGORY:
                c = MeshFacilityCategory.class;
                break;
            case MeshSignageGET.AIRPORT_NAME:
                c = MeshAirport.class;
                break;
            case MeshSignageGET.DEPARTURE_FLIGHT:
                c = MeshDepartureFlight.class;
                break;
            case MeshSignageGET.ARRIVAL_FLIGHT:
                c = MeshArrivalFlight.class;
                break;
            case MeshSignageGET.SHOPPING_ITEM:
                c = MeshShoppingItem.class;
                break;
            case MeshSignageGET.SHOPPING_CATEGORY:
                c = MeshShoppingCategory.class;
                break;
            case MeshSignageGET.MESSAGE:
                c = MeshMessage.class;
                break;
            case MeshSignageGET.LIVESTREAM_SER:
                c = MeshStream.class;
                break;
            case MeshSignageGET.LIVESTREAM_CAT:
                c = MeshStreamCategory.class;
                break;
            case MeshSignageGET.EXTRAS:
                c = MeshTag.class;
                break;
            case MeshSignageGET.VC:
                c = MeshVC.class;
                break;
            case MeshSignageGET.MAP_CATEGORIES:
                c = MeshVCCategory.class;
                break;
            case MeshSignageGET.WEATHER:
                c = MeshWeatherV2.class;
                break;
            case MeshSignageGET.WEATHER_FORECAST:
                c = MeshWeatherForecast.class;
                break;
            case MeshSignageGET.VOD:
                c = MeshVOD.class;
                break;
            case MeshSignageGET.CONFIG:
                c = MeshConfig.class;
                break;
            case MeshSignageGET.CUSTOMER:
                c = MeshGuest.class;
                break;
            case MeshSignageGET.GENRES:
                c = MeshGenre.class;
                break;
    ...
    private String getFromLive()
    {
        try
        {
            ...
            {
                api = MeshSignageGET.SCHEDULE;
            }
            else if ( c == MeshCompany.class)
            {
                api = MeshSignageGET.COMPANY;
            }
            else if ( c == MeshSignage.class)
            {
                api = MeshSignageGET.SIGNAGE;
            }
            else if ( c == MeshSignageSchedule.class)
            {
                api = MeshSignageGET.SIGNAGE_SCHEDULE;
            }
            else if ( c == MeshLayout.class)
            {
                api = MeshSignageGET.LAYOUT;
            }
            else if (c == MeshTelecomBill.class)
            {
                api = MeshSignageGET.TELE_BILL;
            }
            else if (c == MeshEPG.class)
            {
                api = MeshSignageGET.EPG;
            }
            else if (c == MeshSubscriber.class)
            {
                api = MeshSignageGET.SUBSCRIBERS;
            }
            else if(c == MeshPackage.class)
            {
                api = MeshSignageGET.PACKAGES;

            }
            else if (c == MeshPackageChannel.class)
            {
                api = MeshSignageGET.PACKAGE_CHANNELS;

            }
            else if (c == MeshSubscription.class)
            {
                api = MeshSignageGET.SUBSCRIPTIONS;

            }
            else if(c ==MeshVODBought.class)
            {
                api = MeshSignageGET.VOD_BOUGHT;
            }
            else if(c == MeshAirMedia.class)
            {
                api = MeshSignageGET.AIRMEDIA_USER;
            }
            ...
            {
                api = MeshSignageGET.TV;
            }
            else if (c == MeshChannelCategory.class)
            {
                api = MeshSignageGET.TV_CATEGORY;
            }
            else if (c == MeshConciergeRequestItem.class)
            {
                api = MeshSignageGET.ITEM_REQ;

            }
            else if (c == MeshConciergeRequestService.class)
            {
                api = MeshSignageGET.SVC_REQ;
            }
            else if (c == MeshFood.class)
            {
                api = MeshSignageGET.FOOD;
            }
            else if (c == MeshFoodCategory.class)
            {
                api = MeshSignageGET.FOOD_CATEGORY;
            }
            else if (c == MeshFacility.class)
            {
                api = MeshSignageGET.FACILITY;
            }
            else if (c == MeshFacilityCategory.class)
            {
                api = MeshSignageGET.FACILITY_CATEGORY;
            }
            else if (c == MeshAirport.class)
            {
                api = MeshSignageGET.AIRPORT_NAME;
            }
            else if ( c == MeshDepartureFlight.class)
            {
                api = MeshSignageGET.DEPARTURE_FLIGHT;
            }
            else if ( c== MeshArrivalFlight.class)
            {
                api = MeshSignageGET.ARRIVAL_FLIGHT;
            }

            else if ( c == MeshMessage.class)
            {
                api = MeshSignageGET.MESSAGE;
            }
            else if ( c == MeshShoppingCategory.class)
            {
                api = MeshSignageGET.SHOPPING_CATEGORY;
            }
            else if ( c == MeshShoppingItem.class)
            {
                api = MeshSignageGET.SHOPPING_ITEM;
            }
            else if ( c == MeshStream.class)
            {
                api = MeshSignageGET.LIVESTREAM_SER;
            }
            else if ( c == MeshStreamCategory.class)
            {
                api = MeshSignageGET.LIVESTREAM_CAT;
            }
            else if ( c == MeshTag.class)
            {
                api = MeshSignageGET.EXTRAS;
            }
            else if (c == MeshVC.class)
            {
                api = MeshSignageGET.VC;
            }
            else if (c == MeshVCCategory.class)
            {
                api = MeshSignageGET.MAP_CATEGORIES;

            }
            else if (c == MeshWeatherV2.class)
            {
                api = MeshSignageGET.WEATHER;

            }
            else if (c == MeshWeatherForecast.class)
            {
                api = MeshSignageGET.WEATHER_FORECAST;
            }
            else if(c == MeshVOD.class)
            {
                api = MeshSignageGET.VOD;
            }
            else if(c==MeshConfig.class)
            {
                api = MeshSignageGET.CONFIG;
            }
            else if(c==MeshGuest.class)
            {
                api = MeshSignageGET.CUSTOMER;
            }
            else if(c==MeshGenre.class)
            {
                api = MeshSignageGET.GENRES;
            }
