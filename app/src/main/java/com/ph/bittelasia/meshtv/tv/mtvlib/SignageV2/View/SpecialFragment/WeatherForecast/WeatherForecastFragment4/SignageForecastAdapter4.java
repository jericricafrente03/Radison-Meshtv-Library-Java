package com.ph.bittelasia.meshtv.tv.mtvlib.SignageV2.View.SpecialFragment.WeatherForecast.WeatherForecastFragment4;
...
import com.ph.bittelasia.meshtv.tv.mtvlib.SignageV2.View.SpecialFragment.WeatherForecast.WeatherForecastFragment3.SignageForecastViewHolder3;

import java.util.ArrayList;

@com.ph.bittelasia.meshtv.tv.mtvlib.Core.Control.Annotation.View.ViewHolder.ViewHolderLayout()
public class SignageForecastAdapter4 extends MeshTVAdapter<MeshWeatherForecastDay>{

    public SignageForecastAdapter4(Context context, GridView gv_view, int layoutResourceId, ArrayList<MeshWeatherForecastDay> data) {
        super(context, gv_view, layoutResourceId, data);
    }

    @Override
    public MeshTVVHolder setViewHolder() {
        return new SignageForecastViewHolder4();
    }

    @Override
    public void updateRow(MeshTVVHolder vh, MeshWeatherForecastDay o) {
        SignageForecastViewHolder4 svh = (SignageForecastViewHolder4)vh;
    ...
    public int setLayout() {
        return R.layout.signage_weather_forecast_item_4;
    }
}
