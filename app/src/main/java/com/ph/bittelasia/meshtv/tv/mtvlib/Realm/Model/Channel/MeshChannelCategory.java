...
public class MeshChannelCategory extends RealmObject implements MeshObjectInterface
{

    //================================================Variable======================================
    //------------------------------------------------Constant--------------------------------------
    @Ignore
    public static final String TAG = MeshChannelCategory.class.getSimpleName();
    @Ignore
