...
/**
 * Requests for Concierge Category Data
 * {@link com.ph.bittelasia.meshtv.tv.mtvlib.Realm.Model.Concierge.MeshConciergeCategory MeshConciergeCategory}
 * <br>
 * Implements {@link MeshParamListener MeshParamListener} to set parameters for the API call
 * @author Mars Ray Canizares Araullo
 * @version 1.0
 */
public class MeshGetConciergeCategoryTask extends AsyncTask<Void,Void,String> implements MeshParamListener {

    //==============================================Variable========================================
    //----------------------------------------------Constant----------------------------------------
    public static final String TAG = MeshGetConciergeCategoryTask.class.getSimpleName();
    //----------------------------------------------------------------------------------------------
    //----------------------------------------------Instance----------------------------------------
    /**
     ...
     */
    public MeshGetConciergeCategoryTask(Context context, MeshRequestListener listener) {
        if (context == null) {
    ...
    protected String doInBackground(Void... voids) {
        ...
        return get.get(context, MeshGET.CONCIERGE_CATEGORY, this);
    }
