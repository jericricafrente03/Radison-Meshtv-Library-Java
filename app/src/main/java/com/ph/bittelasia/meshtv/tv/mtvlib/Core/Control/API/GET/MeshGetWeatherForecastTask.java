...
/**
 * Requests for Weather Forecast Data
 * {@link com.ph.bittelasia.meshtv.tv.mtvlib.Realm.Model.WeatherForecast.MeshWeatherForecast MeshWeatherForecast}
 * <br>
...
public class MeshGetWeatherForecastTask extends AsyncTask<Void,Void,String> implements MeshParamListener {

    //==============================================Variable========================================
    //----------------------------------------------Constant----------------------------------------
    public static final String TAG = MeshGetWeatherForecastTask.class.getSimpleName();
    //----------------------------------------------------------------------------------------------
    //----------------------------------------------Instance----------------------------------------
    /**
     ...
     */
    public MeshGetWeatherForecastTask(Context context, MeshRequestListener listener, MeshDataListener dataListener) {
        if (context == null) {
    ...
    protected String doInBackground(Void... voids) {
        ...
        return get.get(context, MeshGET.WEATHER_FORECAST, this);
    }
