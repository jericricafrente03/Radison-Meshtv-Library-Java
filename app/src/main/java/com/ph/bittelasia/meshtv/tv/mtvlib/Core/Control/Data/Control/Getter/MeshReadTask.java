 ...
 * @version 1.0
 */
public class MeshReadTask extends AsyncTask<Void,Void,Void> implements MeshParamListener
{
    //=============================================Variable=========================================
    //---------------------------------------------Constant-----------------------------------------
    public static final String TAG = MeshReadTask.class.getSimpleName();
    //----------------------------------------------------------------------------------------------
    //---------------------------------------------Instance-----------------------------------------
    /**
    ...
    String result = null;
    /**
     * Required by {@link com.ph.bittelasia.meshtv.tv.mtvlib.Core.Control.API.GET.MeshGET MeshGET} - if set to null will use App Context
     */
    Context context;
    //----------------------------------------------------------------------------------------------
    //==============================================================================================
    ...
    /**
     * @param context Required by {@link com.ph.bittelasia.meshtv.tv.mtvlib.Core.Control.API.GET.MeshGET MeshGET} - if set to null will use App Context
     * @param id ID of message to be read
     */
    public MeshReadTask(Context context,int id)
    {
