...
/**
 * Represents instructions on how to use Airmedia for a platform
 * @author Mars Ray Canizares Araullo
 * @version 1.0
 */
public class MeshAirmediaInstructions{
    //=============================================Variable=========================================
    //---------------------------------------------Constant-----------------------------------------
    public static final String TAG      = MeshAirmediaInstructions.class.getSimpleName();
    /**
     * Tag to extract instructions from JSONObject
     */
    public static final String TAG_INS  = "instructions";
    /**
     * Tag to extract text of the instruction
     */
    public static final String TAG_TEXT = "text";
    /**
     * Tag to extract no of the instruction
     */
     ...
     */
    public MeshAirmediaInstructions(String data)
    {
        try
        {
