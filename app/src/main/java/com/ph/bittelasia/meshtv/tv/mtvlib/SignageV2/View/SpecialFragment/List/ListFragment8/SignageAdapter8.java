...
@ViewHolderLayout()
public class SignageAdapter8 extends MeshTVAdapter<MeshTVFeed>
{


    public SignageAdapter8(Context context, ListView lv_list, int layoutResourceId, ArrayList<MeshTVFeed> data) {
    ...
    {
        return new SignageListViewHolder8();
    }

    @Override
    public void updateRow(MeshTVVHolder vh, MeshTVFeed o)
    {
        SignageListViewHolder8 v = (SignageListViewHolder8) vh;
    ...
    public int setLayout()
    {
        ...
        return R.layout.signage_list_item8;
    }
}
