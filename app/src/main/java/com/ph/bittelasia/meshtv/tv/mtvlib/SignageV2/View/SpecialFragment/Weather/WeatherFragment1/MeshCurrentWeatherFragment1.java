package com.ph.bittelasia.meshtv.tv.mtvlib.SignageV2.View.SpecialFragment.Weather.WeatherFragment1;
...
public class MeshCurrentWeatherFragment1 extends BittelSignageCurrentWeatherFragment
{
    //=========================================Variable=============================================
    //-----------------------------------------Constant---------------------------------------------
    public static final String TAG = MeshCurrentWeatherFragment1.class.getSimpleName();
    //----------------------------------------------------------------------------------------------
    //==============================================================================================
    //============================BittelSignageCurrentWeatherFragment===============================
    @Override
    public int setLayoutId() {
        return R.layout.digital_signage_weather_layout1;
    }
