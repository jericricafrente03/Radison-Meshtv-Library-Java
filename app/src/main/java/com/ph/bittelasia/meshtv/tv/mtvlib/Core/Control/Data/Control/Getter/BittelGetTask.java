 ...
 * @version 2.0
 */
class BittelGetTask extends AsyncTask<Void,Void,String> implements MeshParamListener
{
    //=========================================Variable=============================================
    //-----------------------------------------Constant---------------------------------------------
    public static final String TAG = BittelGetTask.class.getSimpleName();
    //----------------------------------------------------------------------------------------------
    //-----------------------------------------Instance---------------------------------------------
    /**
     ...
     */
    BittelGetTask(Class c, MeshDataListener listener)
    {
        this.c = c;
     ...
     */
    BittelGetTask(Class c, MeshDataListener listener,MeshAdditionalParam additionalParam)
    {
        this.c = c;
        this.listener = listener;
        this.context = MeshTVApp.get().getBaseContext();
     ...
     * @param listener Listens for the result of the request
     */
    BittelGetTask(Context context,int dataSource,Class c, MeshDataListener listener)
    {
        this.c = c;
        this.listener = listener;
     ...
     */
    BittelGetTask(Context context,int dataSource,MeshDataListener listener,String data)
    {
        this.listener = listener;
        this.context = context;
        this.dataSource = dataSource;
    ...
    private void setClass(String s)
    {
        ...
        switch (classname)
        {
            ...
            case MeshGET.LAYOUT:
                c = MeshLayout.class;
                break;
            case MeshGET.SCHEDULE:
                c = MeshSchedule.class;

                break;
            case MeshGET.SIGNAGE_SCHEDULE:
                c = MeshSignageSchedule.class;

                break;
            case MeshGET.SIGNAGE:
                c = MeshSignage.class;

                break;
            case MeshGET.COMPANY:
                c = MeshCompany.class;

                break;
            case MeshGET.TELE_BILL:
                c = MeshTelecomBill.class;
                break;
            case MeshGET.EPG:
                c = MeshEPG.class;
                break;
            case MeshGET.SUBSCRIBERS:
                c = MeshSubscriber.class;
                break;
            case MeshGET.SUBSCRIPTIONS:
                c = MeshSubscription.class;
                break;
            case MeshGET.PACKAGES:
                c = MeshPackage.class;
                break;
            case MeshGET.PACKAGE_CHANNELS:
                c = MeshPackageChannel.class;
                break;
            case MeshGET.VOD_BOUGHT:
                c = MeshVODBought.class;
                break;
            case MeshGET.XBILL:
                c = MeshBillV2.class;
                break;
            case MeshGET.AIRMEDIA_USER:
                c = MeshAirMedia.class;
                break;
            case MeshGET.CONCIERGE_CATEGORY:
                c = MeshConciergeCategory.class;
                break;
            case MeshGET.TV:
                c = MeshChannel.class;
                break;
            case MeshGET.TV_CATEGORY:
                c = MeshChannelCategory.class;
                break;
            case MeshGET.ITEM_REQ:
                c= MeshConciergeRequestItem.class;
                break;
            case MeshGET.SVC_REQ:
                c = MeshConciergeRequestService.class;
                break;
            case MeshGET.FOOD:
                c = MeshFood.class;
                break;
            case MeshGET.FOOD_CATEGORY:
                c = MeshFoodCategory.class;
                break;
            case MeshGET.FACILITY:
                c = MeshFacility.class;
                break;
            case MeshGET.FACILITY_CATEGORY:
                c = MeshFacilityCategory.class;
                break;
            case MeshGET.AIRPORT_NAME:
                c = MeshAirport.class;
                break;
            case MeshGET.DEPARTURE_FLIGHT:
                c = MeshDepartureFlight.class;
                break;
            case MeshGET.ARRIVAL_FLIGHT:
                c = MeshArrivalFlight.class;
                break;
            case MeshGET.SHOPPING_ITEM:
                c = MeshShoppingItem.class;
                break;
            case MeshGET.SHOPPING_CATEGORY:
                c = MeshShoppingCategory.class;
                break;
            case MeshGET.MESSAGE:
                c = MeshMessage.class;
                break;
            case MeshGET.LIVESTREAM_SER:
                c = MeshStream.class;
                break;
            case MeshGET.LIVESTREAM_CAT:
            ...
            case MeshGET.VC:
                c = MeshVC.class;
                break;
            case MeshGET.MAP_CATEGORIES:
                c = MeshVCCategory.class;
                break;
            case MeshGET.WEATHER:
                c = MeshWeatherV2.class;
                break;
            case MeshGET.WEATHER_FORECAST:
    ...
    private String getFromLive()
    {
        try
        {
            ...
            {
                api = MeshGET.TV_CATEGORY;
            }
            else if (c == MeshConciergeRequestItem.class)
            {
                api = MeshGET.ITEM_REQ;
            ...
            {
                api = MeshGET.SHOPPING_CATEGORY;
            }
            else if ( c == MeshShoppingItem.class)
            {
                api = MeshGET.SHOPPING_ITEM;
            }
            else if ( c == MeshStream.class)
            {
                api = MeshGET.LIVESTREAM_SER;
            }
            else if ( c == MeshStreamCategory.class)
            {
                api = MeshGET.LIVESTREAM_CAT;
            }
    ...
    public void parse() {
        if (c == MeshChannel.class) {
            ...
            if (channels.size() > 0) {
                ...
                MeshRealmManager.insertBulk(channels);
            } else {
                if (listener != null) {
                    listener.onNoData(c);
                }
        ...
        else if ( c == MeshTVFeed.class)
        {
            ...
            if (scrolls.size() > 0)
            {
                ...
                MeshRealmManager.insertBulk(scrolls);
            }
            else
            {
                if(listener!=null)
        ...
        else if ( c == MeshTelecomBill.class)
        {
            ...
            if (epgs.size() > 0) {
                ...
                MeshRealmManager.insertBulk(epgs);
            }
            else
            {
                if(listener!=null)
        ...
        else if (c == MeshConciergeCategory.class)
        {
            ...
            if (categories.size() > 0) {
                ...
                MeshRealmManager.insertBulk(categories);
            }
            else
            {
                if(listener!=null)
        ...
        else if (c == MeshAirport.class)
        {
            ...
            if (items.size() > 0)
            {
                ...
                MeshRealmManager.insertBulk(items);
            }
            else
            {
                if(listener!=null)
