...
@ViewHolderLayout()
public class SignageAdapter1 extends MeshTVAdapter<MeshTVFeed>
{


    public SignageAdapter1(Context context, ListView lv_list, int layoutResourceId, ArrayList<MeshTVFeed> data) {
    ...
    {
        return new SignageListViewHolder1();
    }

    @Override
    public void updateRow(MeshTVVHolder vh, MeshTVFeed o)
    {
        SignageListViewHolder1 v = (SignageListViewHolder1) vh;
