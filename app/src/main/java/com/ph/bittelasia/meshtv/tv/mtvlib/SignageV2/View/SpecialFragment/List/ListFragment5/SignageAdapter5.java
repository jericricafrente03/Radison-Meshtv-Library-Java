...
import com.ph.bittelasia.meshtv.tv.mtvlib.SignageV2.View.SpecialFragment.List.ListFragment5.SignageListViewHolder5;

import java.util.ArrayList;

@ViewHolderLayout()
public class SignageAdapter5 extends MeshTVAdapter<MeshTVFeed>
{


    public SignageAdapter5(Context context, ListView lv_list, int layoutResourceId, ArrayList<MeshTVFeed> data) {
    ...
    {
        return new SignageListViewHolder5();
    }

    @Override
    public void updateRow(MeshTVVHolder vh, MeshTVFeed o)
    {
        SignageListViewHolder5 v = (SignageListViewHolder5) vh;
