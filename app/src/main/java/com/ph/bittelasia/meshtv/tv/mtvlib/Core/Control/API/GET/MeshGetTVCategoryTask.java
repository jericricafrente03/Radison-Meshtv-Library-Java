...
/**
 * Requests for Channel Category Data
 * {@link com.ph.bittelasia.meshtv.tv.mtvlib.Realm.Model.Channel.MeshChannelCategory MeshChannelCategory}
 * <br>
 * Implements {@link MeshParamListener MeshParamListener} to set parameters for the API call
 * @author Mars Ray Canizares Araullo
 * @version 1.0
 */
public class MeshGetTVCategoryTask extends AsyncTask<Void,Void,String> implements MeshParamListener {

    //==============================================Variable========================================
    //----------------------------------------------Constant----------------------------------------
    public static final String TAG = MeshGetTVCategoryTask.class.getSimpleName();
    //----------------------------------------------------------------------------------------------
    //----------------------------------------------Instance----------------------------------------
    /**
     ...
     */
    public MeshGetTVCategoryTask(Context context, MeshRequestListener listener) {
        if (context == null) {
    ...
    protected String doInBackground(Void... voids) {
        ...
        return get.get(context, MeshGET.TV_CATEGORY, this);
    }
