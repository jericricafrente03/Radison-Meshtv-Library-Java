package com.ph.bittelasia.meshtv.tv.mtvlib.SignageV2.View.SpecialFragment.Weather.WeatherFragment5;
...
public class MeshCurrentWeatherFragment5 extends BittelSignageCurrentWeatherFragment
{
    //=========================================Variable=============================================
    //-----------------------------------------Constant---------------------------------------------
    public static final String TAG = MeshCurrentWeatherFragment5.class.getSimpleName();
    //----------------------------------------------------------------------------------------------
    //==============================================================================================
    //============================BittelSignageCurrentWeatherFragment===============================
    @Override
    public int setLayoutId() {
        return R.layout.digital_signage_weather_layout5;
    }
