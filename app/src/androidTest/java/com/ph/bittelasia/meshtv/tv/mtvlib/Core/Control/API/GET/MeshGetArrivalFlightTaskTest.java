 ...
 */
public class MeshGetArrivalFlightTaskTest {
    String m = null;
    ...
    {
        MeshGetArrivalFlightTask flightTask = new MeshGetArrivalFlightTask(context, new MeshRequestListener() {
            @Override
        ...
        try
        {
            ...
            assertEquals("arrival_flight",object.getString("class"));;
