 ...
 */
public class MeshGetVCTaskTest {
    String m = null;
    ...
    public void testVC() throws Exception
    {
        ...
        MeshGetVCTask vcTask = new MeshGetVCTask(context, new MeshRequestListener() {
            @Override
        ...
        try
        {
            ...
            assertEquals("get_all_establishments",object.getString("class"));;
