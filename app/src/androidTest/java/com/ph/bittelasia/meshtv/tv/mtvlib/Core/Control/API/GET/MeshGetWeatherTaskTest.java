 ...
 */
public class MeshGetWeatherTaskTest {
    String m = null;
    ...
    public void testWeather() throws Exception
    {
        ...
        MeshGetWeatherTask weatherTask = new MeshGetWeatherTask(context, new MeshRequestListener() {
            @Override
        ...
        try
        {
            ...
            assertEquals("get_all_countries_and_weather",object.getString("class"));;
