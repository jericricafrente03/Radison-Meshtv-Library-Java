 ...
 */
public class MeshGetTVCategoryTaskTest
{
    String m = null;
    ...
    @Test
    public void testTVCategory() throws Exception
    {
        MeshGetTVCategoryTask getTVTask = new MeshGetTVCategoryTask(context, new MeshRequestListener() {
            @Override
...
//            assertEquals("get_all_tv_channel",object.getString("class"));;
            assertEquals("get_tv_channel_category",object.getString("class"));;
