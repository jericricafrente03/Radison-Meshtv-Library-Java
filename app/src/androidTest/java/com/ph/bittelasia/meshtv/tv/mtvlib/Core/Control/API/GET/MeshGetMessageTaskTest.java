 ...
 */
public class MeshGetMessageTaskTest {
    String m = null;
    ...
    {
        MeshGetMessageTask meshGetMessageTask = new MeshGetMessageTask(context, new MeshRequestListener() {
            @Override
        ...
        meshGetMessageTask.execute();
        signal.await();
        boolean success = false;
        try
        {
            JSONObject object = new JSONObject(m);
            assertEquals("get_message",object.getString("class"));;
