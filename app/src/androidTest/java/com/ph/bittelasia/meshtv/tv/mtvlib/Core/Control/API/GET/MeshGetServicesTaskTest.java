 ...
 */
public class MeshGetServicesTaskTest {
    String m = null;
    ...
    public void testServices() throws Exception
    {
        ...
        MeshGetServicesTask servicesTask = new MeshGetServicesTask(context, new MeshRequestListener() {
            @Override
        ...
        try
        {
            ...
            assertEquals("get_all_service_request",object.getString("class"));;
