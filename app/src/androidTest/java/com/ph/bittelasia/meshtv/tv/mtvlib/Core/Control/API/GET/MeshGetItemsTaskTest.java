 ...
 */
public class MeshGetItemsTaskTest
{
    String m = null;
    ...
    {
        MeshGetItemsTask itemsTask = new MeshGetItemsTask(context, new MeshRequestListener() {
            @Override
        ...
        try
        {
            ...
            assertEquals("get_all_item_request",object.getString("class"));;
