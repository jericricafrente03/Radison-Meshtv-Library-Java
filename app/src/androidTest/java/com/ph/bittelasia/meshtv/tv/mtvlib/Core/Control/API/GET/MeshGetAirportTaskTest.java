 ...
 */
public class MeshGetAirportTaskTest {
    String m = null;
    ...
    public void testAirport() throws Exception
    {
        ...
        MeshGetAirportTask registerTask = new MeshGetAirportTask(context, new MeshRequestListener() {
            @Override
        ...
        try
        {
            ...
            assertEquals("get_airport_name",object.getString("class"));;
