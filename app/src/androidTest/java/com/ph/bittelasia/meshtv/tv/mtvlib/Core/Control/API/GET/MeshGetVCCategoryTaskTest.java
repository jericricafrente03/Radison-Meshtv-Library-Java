 ...
 */
public class MeshGetVCCategoryTaskTest {
    String m = null;
    ...
    public void testVCCategory() throws Exception
    {
        ...
        MeshGetVCCategoryTask vcCategoryTask = new MeshGetVCCategoryTask(context, new MeshRequestListener() {
            @Override
        ...
        vcCategoryTask.execute();
        signal.await();
        boolean success = false;
        try
        {
            JSONObject object = new JSONObject(m);
            assertEquals("get_maps_categories",object.getString("class"));;
