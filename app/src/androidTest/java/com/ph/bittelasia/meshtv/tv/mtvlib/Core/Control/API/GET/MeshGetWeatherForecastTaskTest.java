 ...
 */
public class MeshGetWeatherForecastTaskTest {
    String m = null;
    ...
    public void testWeatherForecast() throws Exception
    {
        ...
        MeshGetWeatherForecastTask weatherForecastTask = new MeshGetWeatherForecastTask(context, new MeshRequestListener() {
            @Override
        ...
        try
        {
            ...
            assertEquals("weatherforecast",object.getString("class"));;
