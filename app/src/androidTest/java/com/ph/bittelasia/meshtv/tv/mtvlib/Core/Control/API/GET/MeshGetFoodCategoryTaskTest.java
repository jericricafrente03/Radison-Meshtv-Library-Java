 ...
 */
public class MeshGetFoodCategoryTaskTest
{
    String m = null;
    ...
    public void testAirport() throws Exception {
        MeshGetFoodCategoryTask registerTask = new MeshGetFoodCategoryTask(context, new MeshRequestListener() {
            @Override
        ...
        try
        {
            ...
            assertEquals("get_f_and_b_category",object.getString("class"));;
