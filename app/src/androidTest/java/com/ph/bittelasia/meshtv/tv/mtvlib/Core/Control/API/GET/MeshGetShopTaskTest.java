 ...
 */
public class MeshGetShopTaskTest
{
    String m = null;
    ...
    public void testShop() throws Exception
    {
        ...
        MeshGetShopTask shopTask = new MeshGetShopTask(context, new MeshRequestListener() {
            @Override
        ...
        try
        {
            ...
            assertEquals("get_all_shopping_item",object.getString("class"));;
