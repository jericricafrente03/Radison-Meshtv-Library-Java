 ...
 */
public class MeshGetFacilityTaskTest
{
    String m = null;
    ...
    public void testFacility() throws Exception
    {
        ...
        MeshGetFacilityTask facilityTask = new MeshGetFacilityTask(context, new MeshRequestListener() {
            @Override
        ...
        try
        {
            ...
            assertEquals("get_all_facilities",object.getString("class"));;
