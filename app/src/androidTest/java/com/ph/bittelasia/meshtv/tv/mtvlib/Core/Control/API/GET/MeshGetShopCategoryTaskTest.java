 ...
 */
public class MeshGetShopCategoryTaskTest
{
    String m = null;
    ...
    @Test
    public void testShopCategory() throws Exception
    {

        MeshGetShopCategoryTask shopCategoryTask = new MeshGetShopCategoryTask(context, new MeshRequestListener() {
            @Override
        ...
        try
        {
            ...
            assertEquals("shopping_category",object.getString("class"));;
